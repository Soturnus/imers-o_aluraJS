...
var cartaGandalf = {
    nome: "Gandalf",
    imagem: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/GANDALF.jpg/200px-GANDALF.jpg",
    atributos:{
        ataque: 90,
        defesa: 70,
        magia: 120
...
var cartaMaquina
var cartaJogador
var cartas = [cartaPaulo, cartaRafa, cartaGui, cartaLol, cartaNaruto, cartaGandalf, cartaBatman, cartaMarvel]
//            0           1           2          3         4            5            6           7     
...
function proximaRodada(){ 
    ...
    document.getElementById('btnJogar').disabled = true 
    document.getElementsById('btnProximaRodada').disabled = true

    var divResultado = decument.getElementById('resultado')
